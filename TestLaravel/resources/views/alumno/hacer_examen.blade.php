    ...
    <div class="row">
        ...
        @csrf
            ...
            @foreach ($examenPreguntas as $pregunta)
                ...
                <p>{{ $preguntas++ }}.{{ $pregunta->enunciado }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="radio" name="{{ $pregunta->id }}" id="respuesta2" value="{{ $pregunta->respuesta2 }}">
                        <label for="respuesta2">{{ $pregunta->respuesta2 }}</label>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="radio" name="{{ $pregunta->id }}" id="respuesta4" value="{{ $pregunta->respuesta4 }}"> 
            ...
            <button class="btn btn-success mt-4" type="submit">Terminar examen</button>
